 ...
 */
package org.team399.y2012.HumanInterfaceDevices;
...
public class DriverStationUserInterface {
    ...
    public static class PORTS {
        ...
        //public static final int BELT_BUTTON = 2;    //Blue button
       ...
       // public static final int TARGET_SWITCH_HIGH = 1;
        //public static final int TARGET_SWITCH_LOW = 3;
    ...
    /*public String getTargetSwitch() {
        if (!getDigital(PORTS.TARGET_SWITCH_HIGH) && !getDigital(PORTS.TARGET_SWITCH_LOW)) {
            return "MIDDLE";
        } else if (getDigital(PORTS.TARGET_SWITCH_HIGH)) {
            return "HIGH";
        } else if (getDigital(PORTS.TARGET_SWITCH_LOW)) {
            return "LOW";
        }
        return null;
    }
